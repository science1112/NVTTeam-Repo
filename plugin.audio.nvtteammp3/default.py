...
urllist = xbmc.translatePath(os.path.join('special://home/addons/plugin.audio.nvtteammp3',  'lists', 'mp3url.list'))
audio_fanart = ""
iconart = xbmc.translatePath(os.path.join('special://home/addons/plugin.audio.nvtteammp3',  'icon.png'))
...
def all_artists(name, url):
    ...
    addDir('>> Next page',nxtpgurl,31,xbmc.translatePath(os.path.join('special://home/addons/plugin.audio.nvtteammp3', 'art', 'nextpage.jpg')),'')
...
def all_genres(name, url):
    ...
    addDir('>> Next page',nxtpgurl,13,xbmc.translatePath(os.path.join('special://home/addons/plugin.audio.nvtteammp3', 'art', 'nextpage.jpg')))
...
def compilations_list(name,url,iconimage,page):
    ...
    addDir('>> Next page',nxtpgurl,401,xbmc.translatePath(os.path.join('special://home/addons/plugin.audio.nvtteammp3', 'art', 'nextpage.jpg')),str(nextpage))
...
def album_list(name, url): 
    ...
    nxtpgurl = url[:pgnumf]
    nxtpgurl = "%s%s" % (nxtpgurl, pgnum)
    addDir('>> Next page',nxtpgurl,15,xbmc.translatePath(os.path.join('special://home/addons/plugin.audio.nvtteammp3', 'art', 'nextpage.jpg')),'')
    setView('movies', 'album')
...
def myfreemp3_artists(url):
    ...
    for a in alphabet:
        addDir(a, 'http://www.myfreemp3.eu/artists/%s/' % a.lower(),705,xbmc.translatePath(os.path.join('special://home/addons/plugin.audio.nvtteammp3', 'art', a + '.png')), '')
