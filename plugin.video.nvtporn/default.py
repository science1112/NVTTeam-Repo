...
def INDEX():
    utils.addDir('[COLOR white]NVTTeam Porn[/COLOR] [COLOR yellow]Scenes[/COLOR]','',2,'','')
    utils.addDir('[COLOR white]NVTTeam Porn[/COLOR] [COLOR yellow]Movies[/COLOR]','',3,'','')
    utils.addDir('[COLOR white]NVTTeam Porn[/COLOR] [COLOR yellow]Hentai[/COLOR]','http://www.hentaicraving.com/?genre=Uncensored',30,os.path.join(imgDir, 'hc.jpg'),'')
    utils.addDir('[COLOR white]NVTTeam Porn[/COLOR] [COLOR yellow]Tubes[/COLOR]','',6,'','')
    utils.addDir('[COLOR white]NVTTeam Porn[/COLOR] [COLOR yellow]Webcams & Streams[/COLOR]','',7,'','')
    download_path = addon.getSetting('download_path')
    if download_path != '' and os.path.exists(download_path):
        utils.addDir('[COLOR white]NVTTeam Porn[/COLOR] [COLOR yellow]Download Folder[/COLOR]',download_path,4,'','')
...
def STREAMS():
    streamurl = 'https://github.com/NVTTeam Porn01/NVTTeam Porn-V0.0.1/raw/master/plugin.video.nvtporn/streamlist.m3u'
